...
def conv_layer4(inputs, l2bn=False, num_channels=6, num_filters=128, learn_bn=True, wd=1e-4, use_relu=True):
    kernel_size = [3, 3]
    strides = [1, 1]
    num_channels = 1
...
def model_fcnn(num_classes, l2bn=False, input_shape=[128, None, 3], num_filters=[14, 24, 48, 96], wd=1e-3):
