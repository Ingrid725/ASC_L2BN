...
def load_data_2020(feat_path, csv_path, feat_dim, file_type):
    with open(csv_path, 'r') as text_file:
        ...
        for idx, elem in enumerate(lines):
            # eg: audio/airport-barcelona-203-6129-a.wav\tairport
            # 去除'\t'，得到audio/airport-barcelona-203-6129-a.wav和airport
            lines[idx] = lines[idx].split('\t')
            # lines[idx][0] = airport-barcelona-203-6129-a
        ...
        # label_info中第一个元素为filename，第二个元素为label
